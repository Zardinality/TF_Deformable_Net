...
filename = osp.join(osp.dirname(__file__), 'deform_psroi_pooling.so')
_deform_psroi_pooling_module = tf.load_op_library(filename)
deform_psroi_pool = _deform_psroi_pooling_module.deform_psroi_pool
deform_psroi_pool_grad = _deform_psroi_pooling_module.deform_psroi_pool_grad
